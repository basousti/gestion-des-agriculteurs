      ...
      <div className="containers">
        <div className="sign-in">
          <form action="#" onSubmit={handleSubmit}>
            ...
            {/* password verification sends a code to email and change pw in Forget PW  */}
            <button type="submit">Sign In</button>
            <div>
              <p>Don't have an account? <span style={{ cursor: 'pointer', color: '#f2ba38' }} onClick={onRegisterClick}>Sign Up</span></p>
            </div>
          </form>
        </div>
      </div>
